...
flight_info_dest=Reduce(function(x, y) merge(x, y, all=TRUE), list(d_flight_dt_cancel, d_flight_dt_delay,d_nas_delay,d_carrier_delay,d_weather_delay,d_security_delay,d_late_aircraft_delay))
#colnames(flight_info_dest) <- paste("dest", colnames(flight_info_dest), sep = "_")

names(flight_info_dest)[names(flight_info_dest) == 'dest_dest_city_name'] <- 'dest_city_name'
names(flight_info_dest)[names(flight_info_dest) == 'dest_dest_lon'] <- 'dest_lon'
names(flight_info_dest)[names(flight_info_dest) == 'dest_dest_lat'] <- 'dest_lat'


#names(flight_info_dest)[names(flight_info_dest) == 'dep_delay_new.counter'] <- 'dep_delay.counter'
#flight_dt_most_dest
...
names(flight_info)
write.csv(flight_origin,'map_app/www/origin_map.csv')
...
names(flight_info_origin)[names(flight_info_origin) == 'origin_origin_lat'] <- 'origin_lat'
names(flight_info_origin)[names(flight_info_origin) == 'origin_origin_lon'] <- 'origin_lon'
names(flight_info_origin)[names(flight_info_origin) == 'origin_origin_city_name'] <- 'origin_city_name'

#flight_info=merge(flight_dt_cancel,flight_dt_delay)
